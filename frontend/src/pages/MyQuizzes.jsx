    ...
    <main className="min-h-[calc(100vh-80px)] bg-[#11131c] px-4 py-8 text-white sm:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link to="/create-quiz" className="rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 px-5 py-3 text-center font-bold">+ Create Manual Quiz</Link>
        </div>
